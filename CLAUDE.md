...
- **Имейл адреси — две РАЗЛИЧНИ роли, не ги сливай.** `SATORI_EMAIL` е
  ...
  Адресът е `info@iforget.eu` (избран пред `support@` — покрива всичко и не
  обещава екип за поддръжка, какъвто няма).
  **ОТВОРЕНО:** самата кутия още не съществува. SuperHosting дава поща само
  с хостинг план, а тук домейнът е регистриран без такъв. Възможности:
  Zoho безплатен план (истинска кутия, иска смяна на MX), пощенски план в
  SuperHosting (платено, но без пипане по DNS), или пренасочване през
  Cloudflare (безплатно, без истинска кутия).
  **Каквото и да се избере — SPF записът трябва да остане ТОЧНО ЕДИН.**
  Ако новата услуга добави свой SPF до съществуващия за Resend, двата се
  обезсилват взаимно и писмата за парола/потвърждение започват да падат в
  спам. Това е най-вероятното тихо счупване при тази настройка.
