...
- **Статус на бележка** — кръгчето/dot вече САМО превключва open ⇄ прогрес
  ...
  **Обратният път: "Върни в предишното"** в менюто при задържане
  (`reopenItem()`) — показва се САМО върху приключена бележка и САМО извън
  кошчето (в кошчето "връщане" значи друго и двете едно до друго объркват).
